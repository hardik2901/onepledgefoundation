    ...
    <div className='footer-container'>
      <section className='footer-subscription'>
        ...
        <p className='footer-subscription-text'>
          The One Pledge Foundation is a non-profit. We are dedicated to reversing global warming in our lifetime.
        </p>
        <div className='input-areas'>
          <form>
            ...
            />
            <Button buttonStyle='btn--outline' Linkto="subscribe">Subscribe</Button>
          </form>
        </div>
      </section>
